data_directory=../../model_training_data/Fine-ET/RS_fner_3
...
save_checkpoint_after=600000 # Total entities in RS_fner_3: 2364606
...
#python Fine-ET/src/detect_entities.py ../../datasets/figer_gold.json ../../results/Fine-ED/lstm_crf/RS_fner_3/figer.conll $data_directory/figer_gold_lstm_crf.json
#python Fine-ET/src/detect_entities.py ../../datasets/1k-WFB-g/fner_dev.json ../../results/Fine-ED/lstm_crf/RS_fner_3/fner_dev.conll $data_directory/fner_dev_lstm_crf.json
#python Fine-ET/src/detect_entities.py ../../datasets/1k-WFB-g/fner_test.json ../../results/Fine-ED/lstm_crf/RS_fner_3/fner_test.conll $data_directory/fner_test_lstm_crf.json
...
#  time python Fine-ET/src/main_fnet_train.py  $data_directory/ $ckpt_directory/$model_ckpt_name/ 'RS_fner_3.json*.tfrecord' $rnn_hidden_neurons $keep_prob $learning_rate $batch_size $char_embedding_size $char_rnn_hidden_neurons $joint_embedding_size $epochs $save_checkpoint_after --use_mention --use_clean
