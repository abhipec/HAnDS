data_directory=../../model_training_data/Fine-ET/afet_figer
...
epochs=8   # A number such that approx 19-20 million EMs are used in training
save_checkpoint_after=600000 # Total entities in train.json: 2690286
...
#python Fine-ET/src/detect_entities.py ../../datasets/figer_gold.json ../../results/Fine-ED/lstm_crf/afet_figer/figer.conll $data_directory/figer_gold_lstm_crf.json
#python Fine-ET/src/detect_entities.py ../../datasets/1k-WFB-g/fner_dev.json ../../results/Fine-ED/lstm_crf/afet_figer/fner_dev.conll $data_directory/fner_dev_lstm_crf.json
#python Fine-ET/src/detect_entities.py ../../datasets/1k-WFB-g/fner_test.json ../../results/Fine-ED/lstm_crf/afet_figer/fner_test.conll $data_directory/fner_test_lstm_crf.json
...
#  time python Fine-ET/src/main_fnet_train.py  $data_directory/ $ckpt_directory/$model_ckpt_name/ 'train.json*.tfrecord' $rnn_hidden_neurons $keep_prob $learning_rate $batch_size $char_embedding_size $char_rnn_hidden_neurons $joint_embedding_size $epochs $save_checkpoint_after --use_mention --use_clean
...
#  echo "Testing a FNET model on dev data with entities detected by a Fine-ED model."
...
#  echo "Testing a FNET model on test data with entities detected by a Fine-ED model."
...
#  echo "Testing a FNET model on figer data with entities detected by a Fine-ED model."
...
#  bash Fine-ET/src/scripts/report_result_fnet.bash $ckpt_directory/$model_ckpt_name/fner_dev.json_0.tfrecord/ ../../datasets/1k-WFB-g/fner_dev.json 0 ../../datasets/label_patch_fner_to_figer.txt > $ckpt_directory/$model_ckpt_name/fner_dev.json_0.tfrecord/final_result.txt

#  echo "Report results FNER dev data with entities detected by a Fine-ED model."
#  bash Fine-ET/src/scripts/report_result_fnet.bash $ckpt_directory/$model_ckpt_name/fner_dev_lstm_crf.json_0.tfrecord/ ../../datasets/1k-WFB-g/fner_dev.json 0 ../../datasets/label_patch_fner_to_figer.txt > $ckpt_directory/$model_ckpt_name/fner_dev_lstm_crf.json_0.tfrecord/final_result.txt
...
#  bash Fine-ET/src/scripts/report_result_fnet.bash $ckpt_directory/$model_ckpt_name/fner_test.json_0.tfrecord/ ../../datasets/1k-WFB-g/fner_test.json 0 ../../datasets/label_patch_fner_to_figer.txt > $ckpt_directory/$model_ckpt_name/fner_test.json_0.tfrecord/final_result.txt

#  echo "Report results FNER eval data with entities detected by a Fine-ED model."
#  bash Fine-ET/src/scripts/report_result_fnet.bash $ckpt_directory/$model_ckpt_name/fner_test_lstm_crf.json_0.tfrecord/ ../../datasets/1k-WFB-g/fner_test.json 0 ../../datasets/label_patch_fner_to_figer.txt > $ckpt_directory/$model_ckpt_name/fner_test_lstm_crf.json_0.tfrecord/final_result.txt

#  echo "Report results figer data."
#  bash Fine-ET/src/scripts/report_result_fnet.bash $ckpt_directory/$model_ckpt_name/figer_gold.json_0.tfrecord/ ../../datasets/figer_gold.json 0 > $ckpt_directory/$model_ckpt_name/figer_gold.json_0.tfrecord/final_result.txt

#  echo "Report results figer data with entities detected by a Fine-ED model."
#  bash Fine-ET/src/scripts/report_result_fnet.bash $ckpt_directory/$model_ckpt_name/figer_gold_lstm_crf.json_0.tfrecord/ ../../datasets/figer_gold.json 0 > $ckpt_directory/$model_ckpt_name/figer_gold_lstm_crf.json_0.tfrecord/final_result.txt
done
