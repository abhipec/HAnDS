...
def hierarchical_prediction(prediction, num_to_label, threshold=0):
    """
    Return hierarchical prediction.
    """
...
#        print(actual_p)
    new_prediction = np.zeros(prediction.shape, dtype=np.core.numerictypes.float32)
    for label in actual_p:
        new_prediction[label_to_num[label]] = 1
