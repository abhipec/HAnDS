...
library_directory = os.path.join(dir_path, '../', 'lib')
#pylint: disable-msg=C0103
loss_module = tf.load_op_library(library_directory + '/modified_hinge_loss.so')
loss_grad_module = tf.load_op_library(library_directory + '/modified_hinge_loss_grad.so')
